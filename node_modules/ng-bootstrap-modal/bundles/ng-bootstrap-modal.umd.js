(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('rxjs/Observable'), require('rxjs/Subject'), require('rxjs/Subscriber'), require('rxjs/Observer'), require('@angular/common'), require('@angular/platform-browser/animations'), require('@angular/animations')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/router', 'rxjs/Observable', 'rxjs/Subject', 'rxjs/Subscriber', 'rxjs/Observer', '@angular/common', '@angular/platform-browser/animations', '@angular/animations'], factory) :
	(factory((global['ng-bootstrap-modal'] = {}),global.ng.core,global.ng.router,global.Rx,global.Rx,global.Rx,global.Rx,global.ng.common,global.ng.platformBrowser.animations,global.ng.animations));
}(this, (function (exports,core,router,Observable,Subject,Subscriber,Observer,common,animations,animations$1) { 'use strict';
...
//# sourceMappingURL=ng-bootstrap-modal.umd.js.map
